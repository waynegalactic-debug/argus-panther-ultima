...
class RealDataVault:
    ...
    META_SP_INFO = {
        "stock_short_name": "Meta", "en_short_name": "Meta", "stock_code": "META",
        "ipo_date": "20120518", "listed_market": "NASDAQ",
        "security_type": "\u6d77\u5916\u666e\u901a\u80a1", "listed_status": "\u6b63\u5e38\u4e0a\u5e02",
        "corp_cn_name": "Meta Platforms, Inc.", "employees": 78865,
        "corp_profile": "Meta Platforms, Inc.\u4e8e2004\u5e747\u6708\u5728\u7279\u62c9\u534e\u5dde\u6ce8\u518c\u6210\u7acb\u3002",
        "executives": [
            {"name": "Susan Li", "title": "CFO"}, {"name": "Mark Zuckerberg", "title": "CEO"},
            {"name": "Javier Olivan", "title": "COO"}, {"name": "Dina Powell McCormick", "title": "President"},
        ...
        "board_members": [
            "Robert M. Kimmitt", "Andrew W. Houston", "John Elkann", "Mark Zuckerberg",
            "Charles Songhurst", "Peggy Alford", "Patrick Collison", "Nancy Killefer",
            "Marc L. Andreessen", "Tony Xu", "John Arnold", "Dana White", "Dina Powell McCormick",
        ],
    }

    NVDA_SP_INFO = {
        "stock_short_name": "\u82f1\u4f1f\u8fbe", "en_short_name": "Nvidia", "stock_code": "NVDA",
        "ipo_date": "19990122", "listed_market": "NASDAQ", "employees": 42000,
        "corp_profile": "\u82f1\u4f1f\u8fbe\u516c\u53f8\u4e8e1993\u5e744\u6708\u5728\u52a0\u5229\u798f\u5c3c\u4e9a\u5dde\u6ce8\u518c\u6210\u7acb\u3002",
        "executives": [
    ...
    YF_META = {
        "symbol": "META", "name": "Meta Platforms, Inc.", "current_price": 582.90,
        "previous_close": 612.91, "open": 607.895, "day_low": 580.42, "day_high": 610.0,
        "market_cap": 1479647035392, "fifty_two_week_low": 520.26, "fifty_two_week_high": 796.25,
        "trailing_pe": 21.18866, "forward_pe": 15.82777, "beta": 1.246,
        "dividend_rate": 2.1, "dividend_yield": 0.0036, "profit_margins": 0.32837,
        "held_percent_institutions": 0.79278, "held_percent_insiders": 0.00102,
        "fifty_day_average": 605.229, "two_hundred_day_average": 646.512,
        "total_revenue": 214962995200, "net_income": 70586998784,
        "total_cash": 81180000256, "total_debt": 86769000448,
        "revenue_growth": 0.331, "earnings_growth": 0.624,
        "sector": "Communication Services", "industry": "Internet Content & Information",
        "employees": 77986, "recommendation": "strong_buy",
        "target_mean_price": 828.17, "target_high": 1015.0, "target_low": 664.46,
        "number_of_analysts": 58,
    }

    YF_NVDA = {
        "symbol": "NVDA", "name": "NVIDIA Corporation", "current_price": 194.83,
        "previous_close": 197.58, "open": 197.15, "day_low": 192.35, "day_high": 200.055,
        "market_cap": 4718977351680, "fifty_two_week_low": 157.34, "fifty_two_week_high": 236.54,
        "trailing_pe": 29.83614, "forward_pe": 15.26351, "beta": 2.211,
        "dividend_rate": 1.0, "dividend_yield": 0.0051, "profit_margins": 0.62966,
        "held_percent_institutions": 0.70801, "held_percent_insiders": 0.03984,
        "fifty_day_average": 209.796, "two_hundred_day_average": 191.027,
        "total_revenue": 253491003392, "net_income": 159612993536,
        "total_cash": 53171998720, "total_debt": 12814000128,
        "revenue_growth": 0.852, "earnings_growth": 2.145,
        "sector": "Technology", "industry": "Semiconductors", "employees": 42000,
        "recommendation": "strong_buy", "target_mean_price": 301.62,
        "target_high": 500.0, "target_low": 180.0, "number_of_analysts": 58,
        "eps_trailing": 6.53, "eps_forward": 12.76,
    }

    YF_AAPL = {
        "symbol": "AAPL", "name": "Apple Inc.", "current_price": 308.63,
        "previous_close": 294.38, "market_cap": 4532958920704,
        "trailing_pe": 37.319225, "forward_pe": 32.119114, "beta": 1.097,
        "dividend_rate": 1.08, "dividend_yield": 0.0035, "profit_margins": 0.27152,
        "held_percent_institutions": 0.65779, "held_percent_insiders": 0.01631,
        "total_revenue": 451442016256, "net_income": 122575003648,
        "total_cash": 68507000832, "total_debt": 84710998016,
        "revenue_growth": 0.166, "earnings_growth": 0.218,
        "sector": "Technology", "industry": "Consumer Electronics", "employees": 166000,
        "recommendation": "buy", "target_mean_price": 315.09,
        "eps_trailing": 8.27, "eps_forward": 9.61,
    }

    YF_MSFT = {
        "symbol": "MSFT", "name": "Microsoft Corporation", "current_price": 390.49,
        "previous_close": 384.28, "market_cap": 2900729528320,
        "trailing_pe": 23.257294, "forward_pe": 20.160732, "beta": 1.13,
        "dividend_rate": 3.64, "dividend_yield": 0.0093, "profit_margins": 0.39342,
        "held_percent_institutions": 0.75707, "held_percent_insiders": 0.00078,
        "total_revenue": 318272995328, "net_income": 125215997952,
        "total_cash": 78227996672, "total_debt": 125431996416,
        "revenue_growth": 0.183, "earnings_growth": 0.234,
        "sector": "Technology", "industry": "Software - Infrastructure", "employees": 228000,
        "recommendation": "strong_buy", "target_mean_price": 561.11,
        "eps_trailing": 16.79, "eps_forward": 19.37,
    }

    SEC_META = {
        "cik": 1326801, "ticker": "META", "exchange": "Nasdaq",
        "entity_name": "Meta Platforms, Inc.", "sic": 7370,
        "sic_description": "Services-Computer Programming, Data Processing, Etc.",
        "category": "Large accelerated filer", "fiscal_year_end": "1231",
        "phone": "650-543-4800", "public_float": 1600000000000,
        "state_of_incorporation": "DE",
        "former_names": [{"to": "2021-10-27", "from": "2005-05-06", "name": "Facebook Inc"}],
    }

    SEC_NVDA = {
        "cik": 1045810, "ticker": "NVDA", "exchange": "Nasdaq",
        "entity_name": "NVIDIA CORP", "sic": 3674,
        "sic_description": "Semiconductors & Related Devices",
        "category": "Large accelerated filer", "fiscal_year_end": "0131",
        "phone": "408-486-2000", "shares_outstanding": 24200000000,
        "public_float": 4000000000000, "state_of_incorporation": "DE",
    }
    ...
    SEC_META_FINANCIALS = {
        "income_statement": {
            "revenue": 200966000000, "cost_of_revenue": 36175000000,
            "research_and_development": 57372000000, "marketing_and_sales": 11991000000,
            "general_and_administrative": 12152000000, "total_costs_and_expenses": 117690000000,
            "operating_income": 83276000000, "net_income": 60458000000,
            "basic_eps": 23.98, "diluted_eps": 23.49,
        },
        "balance_sheet": {
            "total_assets": 366021000000, "total_current_assets": 108722000000,
            "cash_and_equivalents": 35873000000, "marketable_securities": 45719000000,
            "total_liabilities": 148778000000, "long_term_debt": 58744000000,
            "total_stockholders_equity": 217243000000,
            "property_and_equipment_net": 176400000000, "goodwill": 24534000000,
        },
        "cash_flow": {
            "operating_cash_flow": 124000002048, "free_cash_flow": 25558249472,
    ...
    IMF_GDP_GROWTH = {
        "USA": {"2020": -2.081, "2021": 6.152, "2022": 2.524, "2023": 2.935, "2024": 2.793},
        "CHN": {"2020": 2.337, "2021": 8.556, "2022": 3.112, "2023": 5.377, "2024": 5.003},
        "DEU": {"2020": -4.127, "2021": 3.913, "2022": 1.807, "2023": -0.872, "2024": -0.496},
        "JPN": {"2020": -4.283, "2021": 3.564, "2022": 1.332, "2023": 0.721, "2024": -0.242},
        "GBR": {"2020": -10.048, "2021": 8.543, "2022": 5.150, "2023": 0.272, "2024": 1.088},
        "FRA": {"2020": -7.603, "2021": 6.795, "2022": 2.797, "2023": 1.620, "2024": 1.107},
        "IND": {"2020": -5.778, "2021": 9.690, "2022": 7.609, "2023": 7.210, "2024": 7.099},
        "BRA": {"2020": -3.277, "2021": 4.763, "2022": 3.017, "2023": 3.242, "2024": 3.419},
        "KOR": {"2020": -0.700, "2021": 4.613, "2022": 2.728, "2023": 1.583, "2024": 2.004},
        "RUS": {"2020": -2.654, "2021": 5.866, "2022": -1.435, "2023": 4.067, "2024": 4.922},
    }

    IMF_INFLATION = {
        "USA": {"2020": 1.253, "2021": 4.681, "2022": 7.991, "2023": 4.127, "2024": 2.952},
        "CHN": {"2020": 2.490, "2021": 0.919, "2022": 1.976, "2023": 0.228, "2024": 0.212},
        "DEU": {"2020": 0.365, "2021": 3.219, "2022": 8.673, "2023": 5.999, "2024": 2.481},
        "JPN": {"2020": -0.027, "2021": -0.235, "2022": 2.496, "2023": 3.268, "2024": 2.739},
        "GBR": {"2020": 0.851, "2021": 2.588, "2022": 9.067, "2023": 7.303, "2024": 2.530},
        "FRA": {"2020": 0.526, "2021": 2.068, "2022": 5.903, "2023": 5.661, "2024": 2.317},
        "IND": {"2020": 6.154, "2021": 5.512, "2022": 6.634, "2023": 5.370, "2024": 4.639},
        "BRA": {"2020": 3.212, "2021": 8.302, "2022": 9.280, "2023": 4.594, "2024": 4.367},
        "KOR": {"2020": 0.537, "2021": 2.498, "2022": 5.090, "2023": 3.597, "2024": 2.322},
        "TUR": {"2020": 12.272, "2021": 19.608, "2022": 72.300, "2023": 53.858, "2024": 58.505},
    }

    IMF_COFER_USD = [
        {"period": "2020-Q1", "share": 62.32}, {"period": "2020-Q2", "share": 61.88},
        {"period": "2020-Q3", "share": 61.01}, {"period": "2020-Q4", "share": 59.53},
        {"period": "2021-Q1", "share": 60.06}, {"period": "2021-Q2", "share": 59.85},
        {"period": "2021-Q3", "share": 59.87}, {"period": "2021-Q4", "share": 59.40},
        {"period": "2022-Q1", "share": 59.42}, {"period": "2022-Q2", "share": 60.00},
        {"period": "2022-Q3", "share": 60.43}, {"period": "2022-Q4", "share": 58.95},
        {"period": "2023-Q1", "share": 60.12}, {"period": "2023-Q2", "share": 59.82},
        {"period": "2023-Q3", "share": 59.69}, {"period": "2023-Q4", "share": 58.98},
        {"period": "2024-Q1", "share": 59.51}, {"period": "2024-Q2", "share": 58.86},
        {"period": "2024-Q3", "share": 57.84}, {"period": "2024-Q4", "share": 58.41},
        {"period": "2025-Q1", "share": 58.38}, {"period": "2025-Q2", "share": 56.94},
        {"period": "2025-Q3", "share": 56.60}, {"period": "2025-Q4", "share": 56.42},
    ]
    ...
    NEON_PROJECT = {
        ...
        "org_id": "org-mute-pine-82630168", "org_name": "Bruce",
    }
    ...
    GITHUB_USER = {
        "login": "waynegalactic-debug", "id": 231535927,
    ...
    CANVA_DESIGNS = [
        ...
        },
        {
            ...
            "page_count": 5, "design_types": ["presentation"],
